...
const LargeWidthChat = () => {
    ...
    const onChange = (event: any) => {
        setChat([
            ...chat,
            {time: getCurrentTime(), message: event.target.value}
        ])
    }
    const addMessage = () => {
            ...
            <div className=" w-[70%]  ">
                <div className=" flex flex-col h-screen">
                    ...
                    <div className=" h-full overflow-y-auto">
                        ...
                        <div className=" flex flex-col justify-end items-end mt-6 mr-[10px]">
                            ...
                            <div className=" bg-blue-500 w-[140px] break-words rounded-xl ">
                                ...
                                <h1 className=" px-2 py-2">ASDKC:Skdcskc;skc;sksckdckdscksldcksd;kcs

                                    sdclsdkscscsdckclsd;kcs;;k
                        ...
                        <div className=" flex flex-col justify-start items-start mt-6 ml-[10px]">
                            ...
                            <div className=" bg-white w-[140px] break-words rounded-xl">
                                ...
                                <h1 className=" px-2 py-2">ASDKC:Skdcskc;skc;sksckdc
                    ...
                    <div className=" flex justify-center items-center p-2 w-full ">
                        ...
                        <input type="text" id="typing" onChange={onChange} className="bg-gray-50 border w-[250px] mr-3 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type...." required />
